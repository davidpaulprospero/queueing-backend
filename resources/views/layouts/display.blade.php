...
<html lang="en">
    ...
    <body class="cm-no-transition cm-1-navbar loader-process">
      <div class="loader">
          <div>
              <img src="https://www.lpu.edu.ph/wp-content/uploads/2021/12/LPU-Logo-1024x1024-1.png" width="150px" height="150px">
          </div>
      </div>
        <!-- Starts of Content -->
        @yield('content')
...
<script>
  function completeTicket(ticketObject) {
    // Create a new instance of the Notification class
    var notification = new Notification();
    
    // Call the notification with the ticket object and desired settings
    notification.call([ticketObject], 'en', '', true, true);
    
    // Call the next ticket number and counter here
    // You can use the ticketObject to access the necessary information
    // Implement the logic to fetch the next ticket number and counter and trigger the sound
    
    // Example logic to fetch the next ticket number and counter
    var nextTicketNumber = ticketObject.token + 1; // Assuming the ticket number is incremented by 1
    var nextCounter = ticketObject.counter + 1; // Assuming the counter is incremented by 1
    
    // Create a new ticket object for the next ticket
    var nextTicket = {
      token: nextTicketNumber,
      counter: nextCounter
    };
    
    // Call the notification for the next ticket
    notification.call([nextTicket], 'en', '', true, true);
  }
</script>
