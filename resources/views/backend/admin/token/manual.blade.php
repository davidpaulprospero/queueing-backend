...
<div class="card">
    <div class="card-header bg-danger text-white">
        <div class="row align-items-center">
            <div class="col">
                <h3 class="card-title">{{ trans('app.manual_token') }}</h3>
            </div> 
            <div class="col-auto">
    ...
    <div class="row">
        <div class="col">
                <button class="button btn btn-danger btn-block" type="reset"><span>Reset</span></button>
                </div>
        <div class="col">
                <button class="button btn btn-success btn-block" type="submit"><span>Submit</span></button>
            </div>
